...
function BarreNavCore() {
    const listeOnglets = [['Accueil', '/profil'], ['Profil', '/infoProfil'], ['Remplir un questionnaire', '/newproject'], ["Questions proposées", '/questionsProposees'], ['Moderation', './'], ['Se déconnecter', './logout']]
