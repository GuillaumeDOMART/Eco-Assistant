...
VALUES ('admin@demo.fr', '$2a$10$b8qqjDh64vjz2/KsV9Yc8uYKMDTatn3cL6Bp7Uuhcwg/N0lKPxf2m', 'DEMO', 'Admin', 1),
...
VALUES (1, 'QUESTIONAIRE POUR Administrateur', 'INPROGRESS'),
...
VALUES ('Sur la duree totale du projet, combiens de jours avez-vous passer sur place (au bureau) ?', 6, 'NUMERIC',
        'HORS_PHASE', 'FIRST', 1),
       ('Est-ce que vous vous déplacer à pied pour vous rendre sur place ?', 1, 'QCM', 'HORS_PHASE', 'FIRST', 1),
       ('Combiens de KM est-ce que vous parcourrez en voiture pour vous rendre sur place ?', 2, 'NUMERIC', 'HORS_PHASE',
        'FIRST', 0),
       ('Combiens de salariées ont été mobilisé pour la phase de développements ?', 7, 'NUMERIC', 'DEVELOPPEMENT',
        'FIRST', 1),
...
INSERT INTO reponsepossible (questionasso, questionsuiv, intitule, constanteid)
VALUES (6, 1, 'Veuillez entrer un entier', 2),
...
INSERT INTO calcul(calculopid, reponsepossibleid, nbcalcul, phase)
VALUES (1, 1, 1, 'DEVELOPPEMENT'),
       (3, 2, 1, 'DEVELOPPEMENT'),
       (5, 4, 1, 'DEVELOPPEMENT'),
       (3, 6, 2, 'DEVELOPPEMENT'),
       (5, 7, 2, 'DEVELOPPEMENT');