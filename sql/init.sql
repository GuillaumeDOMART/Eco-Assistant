...
VALUES
    ...
    /*TEST*/
    ('Combien de collaborateurs travaillent sur cette phase ?',
     21, 'NUMERIC', 'TEST', 'FIRST', 1),
    ('Connaissez-vous à peu prés la distance de trajet de vos collaborateurs ?',
     22, 'QCM', 'TEST', 'FIRST', 1),
    ('Quelle est la distance moyenne de trajet de vos collaborateurs pour aller au travail ?',
     23, 'NUMERIC', 'TEST', 'FIRST', 0),
    ('Combien viennent en voiture ?',
     24, 'NUMERIC', 'TEST', 'FIRST', 1),
    ('Combien de PC utilisez-vous pour cette phase ?',
     25, 'NUMERIC', 'TEST', 'FIRST', 1),
...
VALUES
    ...
    (22, 23, 'OUI', 2),
    (22, 24, 'NON', 2),
    (23, 24, 'Veuillez entrer un entier',
     2),
    ...
    (27, 28, 'OUI', 2),
    (27, 29, 'NON', 2),
    (28, 29, 'Veuillez entrer un entier',
     2),
    ...
    (35, 36, 'OUI', 2),
    (35, null, 'NON', 2),
    (36, 37, 'Veuillez entrer un entier',
     2),
    (38, 39, 'OUI', 2),
    (38, 40, 'NON', 2),
    (39, 40, 'Veuillez entrer un entier',
     2),
    (40, null, 'Veuillez entrer un entier',
     2);
