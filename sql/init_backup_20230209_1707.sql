...
INSERT INTO profil
VALUES (1, 'admin@demo.fr', 'admin@demo.com', 'DEMO', 'Admin', 1),
...
INSERT INTO projet
VALUES (1, 2, 'QUESTIONAIRE POUR DEVELOPPEURS', 'INPROGRESS'),
       (2, 3, 'QUESTIONAIRE POUR L EQUIPE SUPPORT', 'INPROGRESS');

--- CREATION DES CONSTANTES
INSERT INTO constante
VALUES (1, 1, 'source1.com'),
       (2, 1, 'source2.com'),
       (3, 1, 'source3.com'),
       (4, 20, 'source4.com');
...
VALUES (1, 'Combien d heures codez-vous par semaine ?', null, 'NUMERIC', 'DEVELOPPEMENT', 'FIRST', 1),
...
INSERT INTO reponsepossible
VALUES (1, 1, 2, 'Veuillez entrer un entier', 1),
       (2, 2, 3, 'Oui', 2),
       (3, 2, null, 'NON', 3),
